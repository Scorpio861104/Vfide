...
CREATE INDEX IF NOT EXISTS idx_indexed_events_data_from ON indexed_events USING GIN ((data->'from'));
CREATE INDEX IF NOT EXISTS idx_indexed_events_data_to ON indexed_events USING GIN ((data->'to'));
...
CREATE INDEX IF NOT EXISTS idx_push_subs_user ON push_subscriptions(user_address);
