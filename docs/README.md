...
│   ├── A11Y_TESTING.md       # Accessibility testing
...
│   └── VERCEL-DEPLOYMENT-ISSUES.md
│
└── archive/                  # Historical/status documents
    └── (progress reports, phase completions, etc.)
```
...
### Feature Guides
- [Wallet Integration](guides/WALLET-INTEGRATION-GUIDE.md)
...
- [Accessibility Testing](testing/A11Y_TESTING.md)

### Deployment
- [Vercel Deployment](guides/VERCEL-DEPLOYMENT-GUIDE.md)
