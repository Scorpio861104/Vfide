      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <button onClick={copyCode}
            className="flex items-center gap-1.5 px-3 py-1.5 bg-accent/20 border border-accent/30 rounded-lg text-accent text-xs font-bold hover:bg-accent/30 transition-colors">
