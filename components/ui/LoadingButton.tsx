...
const variants = {
  primary: 'bg-gradient-to-r from-accent to-blue-500 text-zinc-900 hover:shadow-lg hover:shadow-accent/50',
  secondary: 'bg-zinc-800 border border-zinc-700 text-zinc-100 hover:border-accent',
