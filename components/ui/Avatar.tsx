...
export function Avatar({
  ...
  if (name && name.length > 0) {
    return (
      <div
        className={`${baseRound} bg-gradient-to-br from-cyan-500/30 to-violet-500/30 border border-white/10 flex items-center justify-center font-bold text-cyan-200`}
        role="img"
        aria-label={label}
      >
