...
export function EnhancedBadge({
  ...
  const colorMap = {
    ...
    green: {
      ...
      gradient: "bg-linear-to-r from-emerald-500 to-green-500 text-white",
    ...
    red: {
      ...
      gradient: "bg-linear-to-r from-red-500 to-rose-500 text-white",
    ...
    purple: {
      ...
      gradient: "bg-linear-to-r from-purple-500 to-indigo-500 text-white",
    ...
    gold: {
      ...
      gradient: "bg-linear-to-r from-yellow-500 to-amber-500 text-white",
