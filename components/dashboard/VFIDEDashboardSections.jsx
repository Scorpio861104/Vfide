...
export function SidebarNav({ T, sidebarOpen, setSidebarOpen, activeNav, setActiveNav }) {
  return (
    <nav style={{
...
export function TopBar({ T, stagger, copied, handleCopy }) {
  return (
...
export function HeroRow({ T, stagger, Card, ProofScoreHero, balanceVisible, setBalanceVisible }) {
  return (
...
export function ChartActivityRow({ T, stagger, Card, ChartTooltip }) {
  return (
...
export function EcosystemStatsRow({ T, stagger, Card, IconBadge }) {
  return (
    <div style={stagger(5)}>
...
export function FooterStatus({ T, stagger }) {
  return (
