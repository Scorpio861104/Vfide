...
export default function StreakTracker() {
  ...
  return (
    <motion.div 
      ...
      className="relative bg-gradient-to-br from-[#FF6B35]/10 to-[#F7931E]/10 border border-[#FF6B35]/30 rounded-xl p-6 overflow-hidden"
    >
      ...
      <div className="relative flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          <motion.div 
            ...
            className="relative w-14 h-14 bg-gradient-to-br from-[#FF6B35] to-[#F7931E] rounded-full flex items-center justify-center shadow-lg shadow-orange-500/30"
          >
            <motion.div
              animate={{ 
                scale: [1, 1.2, 1],
        ...
        >
          <motion.div 
            ...
            className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#FF6B35] to-[#F7931E]"
          >
