        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              } top-8 z-50 w-48 bg-zinc-900 border border-zinc-800 rounded-lg shadow-xl overflow-hidden`}
            >
              <div className="py-1">
                {isOwnMessage && onEdit && (
                  <button
                    onClick={handleEdit}
                    className="w-full px-4 py-2 flex items-center gap-3 hover:bg-zinc-800 text-white transition-colors"
                  >
                ...
                {onReport && !isOwnMessage && (
                  <>
                    ...
                    <button
                      ...
                      className="w-full px-4 py-2 flex items-center gap-3 hover:bg-zinc-800 text-yellow-400 transition-colors"
                    >
        ...
        {showDeleteConfirm && (
          ...
          >
            <motion.div
              ...
              className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 max-w-md mx-4"
