...
function SocialFeatures({ className = '' }: SocialFeaturesProps) {
  ...
  const [feedPosts, _setFeedPosts] = useState<FeedPost[]>([]);
      ...
      {['following', 'followers', 'friends'].includes(activeTab) && (
        <div className="mb-6">
          <input
            ...
            className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white  dark: focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
      )}
