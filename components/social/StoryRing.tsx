  ...
  return (
    ...
    >
      ...
      <div className={`${sizeClasses[size]} relative`}>
        <div
          className={`w-full h-full rounded-full overflow-hidden relative ${ringClasses} transition-all`}
        >
          {thumbnail ? (
            <Image src={thumbnail} alt={userName} fill className="object-cover" sizes="80px" />
