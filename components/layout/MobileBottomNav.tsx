...
const moreItems = [
  ...
  { href: '/subscriptions', label: 'Subscriptions', emoji: '🧾', category: 'Finance' },
  ...
  { href: '/about', label: 'About', emoji: '🧭', category: 'System' },
  ...
  { href: '/performance', label: 'Performance', emoji: '⚙️', category: 'System' },
