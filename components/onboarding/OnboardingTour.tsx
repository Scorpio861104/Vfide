                ...
                {currentStep?.id === "vault-security" && (
                  <div className="mt-6 space-y-3">
                    <div className="flex items-start gap-3 p-3 bg-zinc-900 border border-emerald-500 rounded-lg">
                      ...
                      <div>
                        <div className="font-bold text-emerald-500 text-sm">{cardBoundMode ? 'Wallet Rotation' : 'Guardian Recovery'}</div>
                        <div className="text-xs text-zinc-400">{cardBoundMode ? 'Trusted guardians approve signer rotation and protect active vault controls' : 'Trusted friends/family help recover lost wallets'}</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-3 bg-zinc-900 border border-amber-400 rounded-lg">
                      ...
                      <div>
                        <div className="font-bold text-amber-400 text-sm">{cardBoundMode ? 'Guardian Protections' : 'Next of Kin'}</div>
                        <div className="text-xs text-zinc-400">{cardBoundMode ? 'Queued transfer review and guardian governance replace the legacy inheritance path' : 'Designate an heir to inherit your vault'}</div>
                      </div>
                    </div>
                  </div>
                )}
