                ...
                {currentStep?.id === "vault-security" && (
                  <div className="mt-6 space-y-3">
                    <div className="flex items-start gap-3 p-3 bg-zinc-900 border border-emerald-500 rounded-lg">
                      ...
                      <div>
                        <div className="font-bold text-emerald-500 text-sm">Wallet Rotation</div>
                        <div className="text-xs text-zinc-400">Trusted guardians approve signer rotation and protect active vault controls</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-3 bg-zinc-900 border border-amber-400 rounded-lg">
                      ...
                      <div>
                        <div className="font-bold text-amber-400 text-sm">Guardian Protections</div>
                        <div className="text-xs text-zinc-400">Queued transfer review and guardian governance protect vault funds from unauthorized drain</div>
                      </div>
                    </div>
                  </div>
                )}
