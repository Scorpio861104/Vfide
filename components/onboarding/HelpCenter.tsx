        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 bottom-0 w-full max-w-full sm:w-[90vw] md:w-125 bg-gradient-to-br from-zinc-800 to-zinc-900 border-l-2 border-cyan-400 shadow-2xl z-91 overflow-y-auto overflow-x-hidden break-words"
            >
              {/* Header */}
