  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <div className="bg-zinc-900 rounded-xl border border-zinc-700 p-8">
        {/* Header */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-zinc-100 mb-2">Profile Settings</h2>
          <p className="text-sm text-zinc-500">Manage your public profile information</p>
        </div>

        {/* Avatar Section */}
        <div className="mb-8 pb-8 border-b border-zinc-700">
          <h3 className="text-sm font-semibold text-zinc-100 mb-4">Profile Picture</h3>
          <AvatarUpload
        ...
        <div className="bg-zinc-900 rounded-xl border border-zinc-700 p-8">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500">Manage your wallet connection preferences</p>
            </div>
          </div>
          <WalletSettings />
        </div>
