...
export const navigationItems: NavItem[] = [
  ...
  // ─── Merchant ─────────────────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      { id: 'flashloan',      label: 'Flashloans P2P', href: '/merchant?tab=flashloans',    icon: Zap,            color: '#10B981', badge: 'P2P' },
      { id: 'escrow',         label: 'Escrow',         href: '/merchant?tab=escrow',        icon: Lock,           color: '#10B981' },
      { id: 'payroll',        label: 'Payroll',        href: '/merchant?tab=payroll',       icon: Calendar,       color: '#10B981' },
