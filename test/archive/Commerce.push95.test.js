...
describe("VFIDECommerce: Push to 95% Coverage", function() {
  ...
  describe("MerchantRegistry TEST Helpers - Additional Eval Functions", function() {
    ...
    it("should exercise TEST_eval_noteRefund_forceFlag", async function() {
      const result = await registry.TEST_eval_noteRefund_forceFlag();
      expect(result).to.be.a('boolean');
    });

    it("should exercise TEST_eval_noteDispute_forceFlag", async function() {
      const result = await registry.TEST_eval_noteDispute_forceFlag();
      expect(result).to.be.a('boolean');
    });
