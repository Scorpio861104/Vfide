...
import {StablecoinRegistryLegacy} from "contracts/VFIDEFinance.sol";
import {ProofLedger} from "contracts/VFIDETrust.sol";
import {ERC20Mock} from "contracts/mocks/ERC20Mock.sol";

contract FinanceSmoke is Test {
    StablecoinRegistryLegacy registry;
    ProofLedger ledger;
    ...
    function setUp() public {
        ...
        registry = new StablecoinRegistryLegacy(dao, address(ledger));
    }
