...
describe.skip("VFIDECommerce - Exhaustive TEST Coverage (Part 3/3)", function() {
  ...
  describe("Final comprehensive coverage", function() {
    it("should exercise every TEST function at least once", async function() {
      ...
      await registry.TEST_evalreportRefund_forceFlag();
      await registry.TEST_evalreportDispute_forceFlag();
