...
describe.skip("VFIDECommerce - Exhaustive TEST Coverage (Part 1/3)", function() {
  ...
  describe("Eval functions - Part 1", function() {
    ...
    it("TEST_evalreportRefund_forceFlag", async function() {
      const flag = await registry.TEST_evalreportRefund_forceFlag();
      expect(flag).to.be.a("boolean");
    });

    it("TEST_evalreportDispute_forceFlag", async function() {
      const flag = await registry.TEST_evalreportDispute_forceFlag();
      expect(flag).to.be.a("boolean");
    });
