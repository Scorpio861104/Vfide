...
describe("coverage.finish.commerce.addMerchant.forceLeft", function () {
    ...
    it("should test merchant registration with valid setup", async function () {
        // Test that a merchant can be registered successfully
        ...
        // Test that attempting to register again fails
        await expect(
