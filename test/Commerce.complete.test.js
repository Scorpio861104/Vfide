...
describe.skip("Commerce Complete Coverage", function() {
  ...
  beforeEach(async function() {
    ...
    const TK = await ethers.getContractFactory("ERC20Mock");
    token = await TK.deploy("Token", "TKN");

    const HubMock = await ethers.getContractFactory("VaultHubMock");
    ...
    const SecMock = await ethers.getContractFactory("SecurityHubMock");
