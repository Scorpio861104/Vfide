      ...
      {mutualFriends.length <= 3 ? (
        <div className="space-y-2">
          {mutualFriends.map((friend) => (
            ...
            >
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#00F0FF] to-[#A78BFA] flex items-center justify-center text-xs font-bold text-[#F5F3E8]">
        ...
        <div>
          <div className="flex -space-x-2 mb-2">
            {mutualFriends.slice(0, 5).map((friend, index) => (
              <div
                key={friend.address}
                className="w-8 h-8 rounded-full bg-gradient-to-br from-[#00F0FF] to-[#A78BFA] flex items-center justify-center text-xs font-bold text-[#F5F3E8] border-2 border-[#0A0A0F]"
