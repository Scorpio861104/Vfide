        ...
        <div className="flex justify-between items-center mt-8">
          ...
          {step < steps.length - 1 ? (
            <button
              ...
              className="px-6 py-2 bg-gradient-to-r from-[#50C878] to-[#40B868] text-white font-bold rounded-lg hover:shadow-lg transition-all"
            >
              Next →
            </button>
          ) : (
            <button
              ...
              className="px-6 py-2 bg-gradient-to-r from-[#50C878] to-[#40B868] text-white font-bold rounded-lg hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
