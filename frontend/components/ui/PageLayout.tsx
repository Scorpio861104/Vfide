...
export function PageWrapper({ 
  ...
  const backgrounds: Record<string, string> = {
    default: 'bg-gradient-to-b from-[#1A1A1D] via-[#0D0D0F] to-[#1A1A1D]',
    cosmic: 'bg-gradient-to-br from-[#0D0221] via-[#1A1A1D] to-[#0A0A12]',
    aurora: 'bg-gradient-to-br from-[#1A1A1D] via-[#0D1520] to-[#0A1515]',
        ...
        <div className="text-center">
          ...
          {icon && (
            <motion.div 
              ...
              className={`w-20 h-20 bg-gradient-to-br ${iconGradient} rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-[#00F0FF]/20`}
            >
              {icon}
            </motion.div>
          )}
        ...
        {tabs.map((tab) => (
          <motion.button
            ...
            className={`
              ...
              ${activeTab === tab.id 
                ? 'bg-gradient-to-r from-[#00F0FF] to-[#00A8B5] text-black shadow-lg shadow-[#00F0FF]/20' 
            ...
            >
              ...
              {activeTab === tab.id && (
                <motion.div
                  ...
                  className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-[#00F0FF] to-[#50C878]"
                />
              )}
            </button>
          ))}
        ...
        >
          {activeTab === tab.id && (
            <motion.div
              ...
              className="absolute inset-0 bg-gradient-to-r from-[#00F0FF] to-[#50C878] rounded-lg"
