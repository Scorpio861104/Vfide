        ...
        {isConnected && wallet && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            >
              ...
              <div className="text-white text-3xl font-bold mb-1">{wallet.balance}</div>
              <div className="text-gray-400 text-sm">≈ ${wallet.usdValue.toFixed(2)} USD</div>
            </motion.div>
            ...
            >
              ...
              <div className="text-white text-3xl font-bold mb-1">{wallet.tokenBalance}</div>
