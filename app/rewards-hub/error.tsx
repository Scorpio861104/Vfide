...
export default function RewardsHubError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    logger.error('Rewards Hub route error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-zinc-900 flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <h1 className="text-2xl font-bold text-zinc-100 mb-3">Rewards Hub Error</h1>
        <p className="text-zinc-400 mb-2">
          Something went wrong loading your rewards. Retry to fetch the latest on-chain state.
        </p>
        {error.digest && (
