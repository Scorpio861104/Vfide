  ...
  if (reduce) {
    return (
      <div id="fee-river" className="w-full rounded-3xl border border-white/10 bg-zinc-950/70 p-5 sm:p-7">
        <div className="mb-4">
          <div className="mb-1 inline-flex items-center gap-2 rounded-full border border-accent/30 bg-cyan-500/10 px-3 py-1 text-xs uppercase tracking-widest text-accent">
