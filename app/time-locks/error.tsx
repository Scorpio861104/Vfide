...
export default function TimeLocksError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    logger.error('Time-locks route error:', error);
  }, [error]);
    ...
    <div className="min-h-screen bg-zinc-900 flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <p className="text-zinc-400 mb-2">
          Something went wrong loading this page. The time-locks page is currently a placeholder for a future feature, so no funds or on-chain state are involved.
        </p>
        {error.digest && (
