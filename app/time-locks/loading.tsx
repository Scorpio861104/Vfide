/**
 * Loading skeleton for /time-locks.
 *
 * The /time-locks page is currently a ComingSoonPage — user-configurable
 * transaction time locks are designed but not yet shipped. This skeleton
 * intentionally matches the shape of ComingSoonPage (notice block + header
 * + description) so users do not see a flash of fake "dashboard" UI before
 * the placeholder renders. See app/time-locks/page.tsx.
 */
export default function TimeLocksLoading() {
  return (
