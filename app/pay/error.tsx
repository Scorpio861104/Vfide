  ...
  return (
    <div className="min-h-screen bg-zinc-900 flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <h1 className="text-2xl font-bold text-zinc-100 mb-3">Payment Error</h1>
        <p className="text-zinc-400 mb-2">
          An error occurred during the payment flow. If a transaction was submitted, check your wallet for confirmation status.
        </p>
        {error.digest && (
