  ...
  return (
    <div className="space-y-6">
      <div className="bg-white/3 border border-white/10 rounded-2xl p-6">
        ...
        <p className="text-gray-400">Social analytics metrics are not available in this environment yet.</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <section className="bg-white/3 border border-white/10 rounded-2xl p-6">
          ...
          <p className="text-gray-400">Influence scoring is unavailable until live analytics data is connected.</p>
        </section>

        <section className="bg-white/3 border border-white/10 rounded-2xl p-6">
          <h2 className="text-xl font-bold text-white mb-2">Engagement Trends</h2>
          <p className="text-gray-400">Engagement trend visualizations will appear once enough community events are recorded.</p>
        </section>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <section className="bg-white/3 border border-white/10 rounded-2xl p-6">
          ...
          <p className="text-gray-400">Community health insights are currently running in fallback mode.</p>
        </section>

        <section className="bg-white/3 border border-white/10 rounded-2xl p-6">
          <h2 className="text-xl font-bold text-white mb-2">Insights & Recommendations</h2>
          <p className="text-gray-400">Actionable recommendations will appear here after social events begin syncing.</p>
        </section>
      </div>
