/**
 * Loading skeleton for /lending.
 *
 * The /lending page is currently a ComingSoonPage — peer-to-peer lending
 * (with guardian co-signing and ProofScore-driven limits) is designed but
 * not yet shipped. This skeleton intentionally matches the shape of
 * ComingSoonPage (notice block + header + description) so users do not see
 * a flash of fake "lending dashboard" UI before the placeholder renders.
 * See app/lending/page.tsx.
 *
 * NOTE: app/lending/components/ contains orphan tab files (BrowseTab,
 * MyLoansTab, OfferTab) that are not currently imported anywhere. They
 * are scaffolding for the future implementation, kept for reference.
 */
