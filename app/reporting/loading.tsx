/**
 * Loading skeleton for /reporting.
 *
 * The /reporting page is currently a ComingSoonPage — Reports & Dashboards
 * (cross-feature reporting and custom analytics) is designed but not yet
 * shipped. This skeleton intentionally matches the shape of ComingSoonPage
 * (notice block + header + description) so users do not see a flash of fake
 * "dashboard" UI before the placeholder renders. See app/reporting/page.tsx.
 */
