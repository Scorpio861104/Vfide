...
const TAB_LABELS: Record<TabId, string> = { 'active': 'Active', 'submit': 'Submit Appeal', 'resolved': 'Resolved' };
      ...
      <div className="min-h-screen bg-zinc-950 pt-20">
        <div className="container mx-auto px-4 max-w-6xl py-8">
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
            className="text-4xl font-bold text-white mb-2">Appeals</motion.h1>
          <p className="text-white/60 mb-8">Dispute resolution</p>
