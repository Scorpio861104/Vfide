        ...
        <section className="py-12 relative">
          <div className="container mx-auto max-w-5xl px-4">
            <div className="mb-6 flex items-center gap-3">
              <span className="badge-live"><span className="badge-live-dot" />Dispute Operations</span>
            </div>
            <h1 className="text-4xl font-bold mb-2">
              <span className="bg-gradient-to-r from-amber-400 via-orange-400 to-red-400 bg-clip-text text-transparent flex items-center gap-3">
                <Scale size={32} className="text-amber-400" />Disputes &amp; Mediation
              </span>
            </h1>
            <p className="mt-2 max-w-3xl text-white/50">Review merchant returns, escalation paths, and peer mediation from one dispute operations workspace.</p>
