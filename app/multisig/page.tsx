  ...
  return (
    <div className="container mx-auto px-4 py-8 pt-20 pb-24 md:pb-8 space-y-6">
      <div className="rounded-lg border border-amber-400/30 bg-amber-500/10 px-4 py-3 text-sm text-amber-200">
        Multisig live data is not connected in this environment yet. Connect a multisig backend or contract indexer to enable signer and transaction sync.
      </div>
      {/* Header */}
      ...
      <div className="bg-card rounded-xl p-4 border">
        ...
        {signers.length === 0 ? (
          <p className="text-sm text-muted-foreground py-3">
            No live signer records available.
          </p>
        ) : (
      ...
      <div>
        ...
        {transactions.length === 0 ? (
          <div className="bg-card rounded-xl p-4 border text-sm text-muted-foreground">
            No live multisig transactions found.
          </div>
        ) : (
