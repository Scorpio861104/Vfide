/**
 * Loading skeleton for /agent.
 *
 * The /agent page is currently a ComingSoonPage — Cash Agent Mode (operator
 * workflow for in-person cash-in/cash-out) is designed but not yet shipped.
 * This skeleton intentionally matches the shape of ComingSoonPage (notice
 * block + header + description) so users do not see a flash of fake "agent
 * dashboard" UI before the placeholder renders. See app/agent/page.tsx.
 */
