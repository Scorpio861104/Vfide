 ...
 * 
 * Target users: customers browsing on 3G phones.
 * Must render meaningful content in <2s on slow connections.
 */
...
async function fetchMerchant(slug: string) {
  // Server-side fetch — no client JS needed for initial render
...
export default async function StorePage({ params }: StorePageProps) {
  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      {/* Server-rendered header — instant paint, full SEO */}
      ...
      {/* Client island — only the interactive parts need JS */}
      <StoreClient
        merchant={merchant}
