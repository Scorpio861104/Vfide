...
export default function RecoverySignError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    logger.error('Recovery Sign route error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-zinc-900 flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <h1 className="text-2xl font-bold text-zinc-100 mb-3">Recovery Sign Error</h1>
        <p className="text-zinc-400 mb-2">
          Something went wrong during the signing step. No vault changes have been made. Retry to continue safely.
        </p>
        {error.digest && (
