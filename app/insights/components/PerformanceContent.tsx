...
import { AnalyticsTab } from '@/app/performance/components/AnalyticsTab';
import { ErrorsTab } from '@/app/performance/components/ErrorsTab';
import { MetricsTab } from '@/app/performance/components/MetricsTab';
import { OverviewTab } from '@/app/performance/components/OverviewTab';
import { PagesTab } from '@/app/performance/components/PagesTab';
          ...
          <motion.div key={activeTab}
            ...
            {activeTab === 'errors' && (
              <ErrorsTab errors={errors} onResolveError={resolveError} onClearAll={clearErrors}
                onExport={(fmt) => exportErrors(fmt as "json" | "csv")} />
            )}
