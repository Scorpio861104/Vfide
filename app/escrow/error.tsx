  ...
  return (
    <div className="min-h-screen bg-zinc-900 flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <h1 className="text-2xl font-bold text-zinc-100 mb-3">Escrow Error</h1>
        <p className="text-zinc-400 mb-2">
          An error occurred in the escrow interface. Escrowed funds on-chain remain locked and secure regardless of UI errors.
        </p>
        {error.digest && (
