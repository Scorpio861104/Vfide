      ...
      <div className="relative container mx-auto px-4 max-w-3xl">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-6">
          <div className="flex items-center gap-3 mb-3">
            <span className="badge-live"><span className="badge-live-dot" />DAO Elections</span>
          </div>
          <h1 className="text-4xl font-bold mb-2">
            <span className="bg-gradient-to-r from-violet-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent flex items-center gap-3">
              <Vote className="text-violet-400" size={32} />Council Elections
            </span>
          </h1>
          <p className="text-white/50">Elect the {electionInfo.councilSize}-member council that governs the protocol. Votes are weighted by ProofScore.</p>
        </motion.div>
