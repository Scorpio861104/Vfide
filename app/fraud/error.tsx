...
export default function FraudError({
  ...
  useEffect(() => {
    logger.error('Fraud error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-zinc-900 flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <h1 className="text-2xl font-bold text-zinc-100 mb-3">Fraud Reporting Error</h1>
        <p className="text-zinc-400 mb-2">
          An error occurred in the fraud reporting interface. On-chain complaints and escrows are
          unaffected by UI errors — the registry is non-custodial.
        </p>
        {error.digest && (
