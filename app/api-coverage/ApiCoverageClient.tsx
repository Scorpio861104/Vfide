...
export default function ApiCoverageClient() {
  ...
  return (
    <main className="min-h-screen bg-zinc-950 md:pt-[3.5rem] text-zinc-100 p-6 md:p-10 relative">
      ...
      <section className="max-w-6xl mx-auto space-y-4">
        <div className="badge-live mb-3">🔌 Developer Tools</div>
          ...
          return (
            <article key={key} className="rounded-xl border border-zinc-700 bg-zinc-900/60 p-4 space-y-3">
              <div className="flex flex-wrap items-center gap-2">
                <span className="rounded-md bg-cyan-500/20 px-2 py-1 text-xs font-semibold text-accent">{endpoint.method}</span>
