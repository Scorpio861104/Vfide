...
export default function MarketplaceError({
  ...
  useEffect(() => {
    logger.error('Marketplace route error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-zinc-900 flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <h1 className="text-2xl font-bold text-zinc-100 mb-3">Marketplace Error</h1>
        <p className="text-zinc-400 mb-2">
          We hit an issue loading marketplace data. Please retry in a moment.
        </p>
        {error.digest && (
