      ...
      <div className="min-h-screen bg-zinc-950 md:pt-[3.5rem] relative overflow-hidden text-white">
        ...
        <div className="container mx-auto max-w-2xl px-4 py-20 relative z-10">
          ...
          >
            ...
            <h1 className="text-3xl font-black text-white mb-3">Developer Portal</h1>
            <p className="text-zinc-400 mb-2 text-sm font-medium">APIs, SDKs, and tools for building on VFIDE.</p>
            <p className="text-zinc-500 text-sm leading-relaxed mb-8">The developer portal goes live with testnet docs, contract ABIs, and an API playground. Smart contract addresses and event schemas are published in the repo now.</p>
