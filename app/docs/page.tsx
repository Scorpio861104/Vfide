...
const TAB_LABELS: Record<TabId, string> = { 'overview': 'Overview', 'learn': 'Learn', 'faq': 'FAQ', 'security': 'Security' };
      ...
      <div className="min-h-screen bg-zinc-950 pt-20">
        <div className="container mx-auto px-4 max-w-6xl py-8">
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
            className="text-4xl font-bold text-white mb-2">Documentation</motion.h1>
          <p className="text-white/60 mb-8">Learn how to use VFIDE</p>
