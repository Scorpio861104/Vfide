...
const STEPS = [
  { icon: <Shield size={15} className="text-accent" />, title: 'Use an offline device', desc: 'Generate the wallet on a computer that is not connected to the internet. Disable Wi-Fi and Bluetooth before generating.' },
