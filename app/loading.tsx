    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-900" role="status" aria-live="polite" aria-label="Loading page content">
      <div className="text-center">
        <div className="relative inline-block">
          <div className="animate-spin w-16 h-16 border-2 border-accent/20 border-t-accent rounded-full" />
        ...
        <div className="flex gap-1.5 justify-center mt-3">
          <span className="animate-bounce w-2 h-2 bg-accent rounded-full" />
          <span
            className="animate-bounce w-2 h-2 bg-accent rounded-full"
