  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-zinc-900 pt-20">
        {/* Header */}
        <section className="py-12 bg-linear-to-b from-zinc-800 to-zinc-900 border-b border-zinc-700">
          <div className="container mx-auto px-3 sm:px-4 max-w-5xl">
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-[family-name:var(--font-display)] font-bold text-zinc-100 mb-2">
                ProofScore Leaderboard
              </h1>
              <p className="text-lg sm:text-xl text-zinc-400 font-[family-name:var(--font-body)]">
        ...
        {/* Timeframe Filter */}
        <section className="py-4 bg-zinc-900 border-b border-zinc-700 sticky top-20 z-40">
          <div className="container mx-auto px-3 sm:px-4 max-w-5xl">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={() => refetch()}
                disabled={isLoading}
                className="flex items-center gap-2 px-3 py-2 bg-zinc-800 border border-zinc-700 rounded-lg text-zinc-400 hover:text-zinc-100 hover:border-cyan-400 transition-colors disabled:opacity-50"
              >
