...
export default function NotificationsError({
  ...
  useEffect(() => {
    logger.error('Notifications route error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-zinc-900 flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <h1 className="text-2xl font-bold text-zinc-100 mb-3">Notifications Error</h1>
        <p className="text-zinc-400 mb-2">
          Notifications failed to load. Retry to fetch unread status and recent activity.
        </p>
        {error.digest && (
