...
export default function SecurityCenterError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    logger.error('Security Center route error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-zinc-900 flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <h1 className="text-2xl font-bold text-zinc-100 mb-3">Security Center Error</h1>
        <p className="text-zinc-400 mb-2">
          Security tools could not be loaded. Retry to restore account protections.
        </p>
        {error.digest && (
