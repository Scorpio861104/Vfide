  ...
  return (
    <div className="min-h-screen bg-zinc-900 flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <h1 className="text-2xl font-bold text-zinc-100 mb-3">Vault Error</h1>
        <p className="text-zinc-400 mb-2">
          An error occurred in the vault interface. Your funds on-chain are not affected by UI errors.
        </p>
        {error.digest && (
