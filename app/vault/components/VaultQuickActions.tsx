      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <GlassCard className="p-6" hover={false}>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="w-full md:max-w-md p-5 bg-gradient-to-r from-accent to-blue-600 text-white rounded-xl font-bold shadow-lg shadow-cyan-500/25 flex items-center justify-center gap-2"
          >
            <RefreshCw size={20} />
            Transfer to Vault
          </motion.button>
