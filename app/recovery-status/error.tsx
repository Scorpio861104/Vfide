...
export default function RecoveryStatusError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    logger.error('Recovery Status route error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-zinc-900 flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <h1 className="text-2xl font-bold text-zinc-100 mb-3">Recovery Status Error</h1>
        <p className="text-zinc-400 mb-2">
          Something went wrong loading your recovery status. No action has been taken. Retry to reload.
        </p>
        {error.digest && (
