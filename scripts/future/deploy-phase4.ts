...
async function main() {
  ...
  console.log('Phase 4 deploy network:', networkName);
  ...
  for (const contractName of phase4Contracts) {
  ...
  console.log(`\nPhase 4 deployment complete. Saved addresses to .deployments/${networkName}.json`);
}
