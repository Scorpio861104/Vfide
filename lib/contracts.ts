...
const CONTRACT_ENV_VAR_MAP: Record<string, string> = {
  ...
  EcoTreasuryVault: 'NEXT_PUBLIC_ECO_TREASURY_VAULT_ADDRESS',
...
function buildContractAddresses(chainId: number = CURRENT_CHAIN_ID) {
  return {
    ...
    EcoTreasuryVault: validateContractAddress(process.env.NEXT_PUBLIC_ECO_TREASURY_VAULT_ADDRESS, 'EcoTreasuryVault', chainId),
    ...
    CommerceEscrow: validateContractAddress(process.env.NEXT_PUBLIC_COMMERCE_ESCROW_ADDRESS, 'CommerceEscrow', chainId),
