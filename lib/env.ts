...
const envSchema = z.object({
  ...
  // Launch-gated feature flags (mirror lib/features.ts ENV_OVERRIDE so every flag is
  // declared + validated here; lib/features.ts reads process.env directly for inlining).
  NEXT_PUBLIC_ENABLE_LENDING: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_TIME_LOCKS: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_MULTISIG: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_REPORTING: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_STREAMING: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_AGENT: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_ESCROW: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_SUBSCRIPTIONS: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_FLASHLOANS: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_BRIDGE: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_SOCIAL_FEED: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_SOCIAL_MESSAGING: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_SOCIAL_PAYMENTS: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_STORIES: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_ENDORSEMENTS: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_MARKETPLACE: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_STOREFRONT: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_OFFLINE_POS: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_BUDGETS: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_TAXES: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_STEALTH_ADDRESSES: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_PAPER_WALLET: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_HARDWARE_WALLET: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_SEER_SERVICE: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_SEER_ACADEMY: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_FLASHLOAN: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_WHATSAPP_RECEIPTS: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_CSV_EXPORT: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_THEME_MANAGER: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_THEME_SHOWCASE: z.string().default('false').transform(v => v === 'true'),
  NEXT_PUBLIC_ENABLE_PIE_MENU: z.string().default('false').transform(v => v === 'true'),
  ...
  NEXT_PUBLIC_MERCHANT_PORTAL_VIEWER_ADDRESS: optionalEthAddress,
  NEXT_PUBLIC_ADMIN_MULTISIG_ADDRESS: optionalEthAddress,
  NEXT_PUBLIC_VFIDE_ACCESS_CONTROL_ADDRESS: optionalEthAddress,
