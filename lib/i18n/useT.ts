...
const overrides: Partial<Record<SupportedLocale, Partial<TranslationKeys>>> = {
  'es-ES': {
    ...
    support_heading: 'Ayuda y soporte', support_subtitle: 'Estamos aquí para ayudarte.', support_tab_faq: 'FAQ',
  ...
  'fr-FR': {
    ...
    support_heading: 'Aide et support', support_subtitle: 'Nous sommes là pour vous aider.', support_tab_faq: 'FAQ',
  ...
  'de-DE': {
    ...
    support_heading: 'Hilfe & Support', support_subtitle: 'Wir sind für Sie da.', support_tab_faq: 'FAQ',
  ...
  'ar-SA': {
    ...
    support_heading: 'المساعدة والدعم', support_subtitle: 'نحن هنا للمساعدة.', support_tab_faq: 'الأسئلة الشائعة',
  ...
  'hi-IN': {
    ...
    support_heading: 'सहायता और समर्थन', support_subtitle: 'हम यहाँ मदद के लिए हैं।', support_tab_faq: 'FAQ',
    ...
    vault_lock: 'वॉल्ट लॉक करें',
    vault_recover: 'वॉल्ट पुनर्प्राप्ति',
    vault_safety: 'सुरक्षा विंडो',
    vault_settings: 'वॉल्ट सेटिंग्स',
    wallet_buy: 'खरीदें / स्वैप करें',
    wallet_connect: 'वॉलेट कनेक्ट करें',
    wallet_guardians: 'गार्जियन सेटअप',
    wallet_hardware: 'हार्डवेयर वॉलेट',
    wallet_paper: 'पेपर वॉलेट',
    wallet_recovery: 'वॉल्ट पुनर्प्राप्ति',
  },
  ...
  'ja-JP': {
    ...
    support_heading: 'ヘルプ & サポート', support_subtitle: 'お手伝いします。', support_tab_faq: 'よくある質問',
  ...
  'zh-CN': {
    ...
    support_heading: '帮助与支持', support_subtitle: '我们在这里为您提供帮助。', support_tab_faq: '常见问题',
