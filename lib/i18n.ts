...
export const REWARDS_TRANSLATIONS: Record<string, {
  ...
  'de-DE': {
    ...
    subheading: 'By Design — für Ihren Schutz',
    body: 'VFIDE ist ein Governance-Utility-Token. Es gibt keine Empfehlungsboni, Händleranreize, Sperrungsboni oder andere Gewinnverteilungsmechanismen — by Design, um sicherzustellen, dass VFIDE nicht als Wertpapier eingestuft wird.',
