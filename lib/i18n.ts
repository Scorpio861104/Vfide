...
export const STUB_TRANSLATIONS: TranslationMap<StubCopy> = {
  ...
  'es-ES': { comingSoon: 'Próximamente', description: 'Esta función está en desarrollo activo y estará disponible en el lanzamiento de mainnet.', notifyMe: 'Notificarme', backToHome: 'Volver al Inicio' },
  'fr-FR': { comingSoon: 'Bientôt', description: 'Cette fonction est en développement actif et sera disponible lors du lanzamiento du mainnet.', notifyMe: 'Me prévenir', backToHome: 'Retour à l'accueil' },
  'de-DE': { comingSoon: 'Kommt bald', description: 'Diese Funktion befindet sich in aktiver Entwicklung und wird beim Mainnet-Start verfügbar sein.', notifyMe: 'Benachrichtigen', backToHome: 'Zur Startseite' },
  'ar-SA': { comingSoon: 'قريباً', description: 'هذه الميزة قيد التطوير النشط وستكون متاحة عند إطلاق الشبكة الرئيسية.', notifyMe: 'أخبرني', backToHome: 'العودة إلى الرئيسية' },
  ...
  'hi-IN': { comingSoon: 'जल्द आ रहा है', description: 'यह सुविधा सक्रिय विकास के अंतर्गत है और मेननेट लॉन्च पर उपलब्ध होगी।', notifyMe: 'मुझे सूचित करें', backToHome: 'मुखपृष्ठ पर वापस जाएं' },
