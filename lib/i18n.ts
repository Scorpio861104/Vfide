...
// ─── REWARDS_TRANSLATIONS ───────────────────────────────────────────────────
export const REWARDS_TRANSLATIONS: Record<string, {
  heading: string; subheading: string; body: string; whatYouGet: string;
  govVotingTitle: string; govVotingDesc: string;
  protocolAccessTitle: string; protocolAccessDesc: string;
  dutyPointsTitle: string; dutyPointsDesc: string;
  whyNoRewardsTitle: string; whyNoRewardsBody: string;
  govCta: string; docsCta: string;
}> = {
  'en-US': {
    heading: 'No Token Rewards',
    subheading: 'By design — for your protection',
    body: 'VFIDE is a governance utility token. There are no referral bonuses, merchant incentives, lock bonuses, or any other profit-distribution mechanisms — by design, to ensure VFIDE is not classified as a security under the Howey Test.',
    whatYouGet: 'What You Do Get',
    govVotingTitle: 'Governance Voting Rights',
    govVotingDesc: 'Participate in DAO proposals and shape the direction of the protocol.',
    protocolAccessTitle: 'Protocol Access',
    protocolAccessDesc: 'Use VFIDE tokens to pay commerce fees, vault fees, and access premium features.',
    dutyPointsTitle: 'Governance Duty Points',
    dutyPointsDesc: 'Non-transferable participation tracking that reflects your protocol contribution — not profit.',
    whyNoRewardsTitle: 'Why no rewards?',
    whyNoRewardsBody: 'Referral bonuses, merchant incentives, and yield create an expectation of profits from the efforts of others — the third and fourth prongs of the Howey Test. VFIDE deliberately omits all such mechanisms so that holding or using the token cannot be construed as an investment contract.',
    govCta: 'Go to Governance',
    docsCta: 'Read the Docs',
  },
  'es-ES': {
    heading: 'Sin Recompensas de Token',
    subheading: 'Por diseño — para tu protección',
    body: 'VFIDE es un token de utilidad de gobernanza. No hay bonificaciones por referidos, incentivos para comerciantes, bonos de bloqueo ni ningún otro mecanismo de distribución de ganancias — por diseño, para garantizar que VFIDE no se clasifique como un valor bajo el Test Howey.',
    whatYouGet: 'Lo que sí obtienes',
    govVotingTitle: 'Derechos de Voto en Gobernanza',
    govVotingDesc: 'Participa en propuestas de la DAO y da forma a la dirección del protocolo.',
    protocolAccessTitle: 'Acceso al Protocolo',
    protocolAccessDesc: 'Usa tokens VFIDE para pagar tarifas de comercio, tarifas de bóveda y acceder a funciones premium.',
    dutyPointsTitle: 'Puntos de Deber de Gobernanza',
    dutyPointsDesc: 'Seguimiento de participación no transferible que refleja tu contribución al protocolo — no ganancias.',
    whyNoRewardsTitle: '¿Por qué no hay recompensas?',
    whyNoRewardsBody: 'Los bonos de referidos, los incentivos para comerciantes y el rendimiento crean una expectativa de ganancias derivadas del esfuerzo de otros — el tercer y cuarto criterio del Test Howey. VFIDE omite deliberadamente todos esos mecanismos.',
    govCta: 'Ir a Gobernanza',
  ...
  'fr-FR': {
    ...
    protocolAccessTitle: 'Accès au Protocole',
    protocolAccessDesc: 'Utilisez les tokens VFIDE pour payer les frais de commerce, de coffre et accéder aux fonctionnalités premium.',
    dutyPointsTitle: 'Points de Devoir de Gouvernance',
    dutyPointsDesc: 'Suivi de participation non transférable reflétant votre contribution au protocole — pas les profits.',
    whyNoRewardsTitle: 'Pourquoi pas de récompenses ?',
    whyNoRewardsBody: 'Les bonus de parrainage, les incitations marchandes et le rendement créent une attente de profits issus des efforts des autres — troisième et quatrième critères du test Howey. VFIDE omet délibérément tous ces mécanismes.',
    govCta: 'Aller à la Gouvernance',
    docsCta: 'Lire la Documentation',
  },
  'de-DE': {
    heading: 'Keine Token-Belohnungen',
    subheading: 'Beabsichtigt — zu Ihrem Schutz',
    body: 'VFIDE ist ein Governance-Utility-Token. Es gibt keine Empfehlungsboni, Händleranreize, Sperrungsboni oder andere Gewinnverteilungsmechanismen — absichtlich, um sicherzustellen, dass VFIDE nicht als Wertpapier eingestuft wird.',
    whatYouGet: 'Was Sie bekommen',
    govVotingTitle: 'Governance-Stimmrechte',
    govVotingDesc: 'Nehmen Sie an DAO-Vorschlägen teil und gestalten Sie die Richtung des Protokolls.',
    protocolAccessTitle: 'Protokollzugang',
    protocolAccessDesc: 'Verwenden Sie VFIDE-Token, um Handels- und Vault-Gebühren zu bezahlen und auf Premium-Funktionen zuzugreifen.',
    dutyPointsTitle: 'Governance-Pflichtpunkte',
    dutyPointsDesc: 'Nicht übertragbares Teilnahme-Tracking, das Ihren Protokollbeitrag widerspiegelt — keinen Gewinn.',
    whyNoRewardsTitle: 'Warum keine Belohnungen?',
    whyNoRewardsBody: 'Empfehlungsboni, Händleranreize und Renditen schaffen eine Gewinnerwartung durch die Bemühungen anderer — drittes und viertes Kriterium des Howey-Tests. VFIDE lässt all solche Mechanismen bewusst aus.',
    govCta: 'Zur Governance',
    docsCta: 'Dokumentation lesen',
  },
  'ar-SA': {
    heading: 'لا مكافآت للرمز',
    subheading: 'بتصميم — لحمايتك',
    body: 'VFIDE هو رمز مرافق للحوكمة. لا توجد مكافآت إحالة أو حوافز للتجار أو مكافآت تأمين أو أي آليات توزيع أرباح أخرى — بتصميم، لضمان عدم تصنيف VFIDE كورقة مالية.',
    whatYouGet: 'ما تحصل عليه',
    govVotingTitle: 'حقوق التصويت في الحوكمة',
    govVotingDesc: 'شارك في مقترحات DAO وشكّل اتجاه البروتوكول.',
    protocolAccessTitle: 'الوصول إلى البروتوكول',
    protocolAccessDesc: 'استخدم رموز VFIDE لدفع رسوم التجارة ورسوم الخزنة والوصول إلى الميزات المميزة.',
    dutyPointsTitle: 'نقاط واجب الحوكمة',
    dutyPointsDesc: 'تتبع مشاركة غير قابل للنقل يعكس مساهمتك في البروتوكول — وليس الأرباح.',
    whyNoRewardsTitle: 'لماذا لا توجد مكافآت؟',
    whyNoRewardsBody: 'تخلق مكافآت الإحالة وحوافز التجار والعوائد توقعاً بالأرباح من جهود الآخرين — المعيار الثالث والرابع لاختبار هاوي. يتجنب VFIDE عمداً جميع هذه الآليات.',
    govCta: 'الذهاب إلى الحوكمة',
    docsCta: 'قراءة الوثائق',
  },
  'fil-PH': {
    heading: 'Walang Token Rewards',
    subheading: 'Sa disenyo — para sa iyong proteksyon',
    body: 'Ang VFIDE ay isang governance utility token. Walang referral bonuses, merchant incentives, lock bonuses, o anumang profit-distribution mechanisms — sa disenyo, upang matiyak na ang VFIDE ay hindi maklasipika bilang security.',
    whatYouGet: 'Ano ang Matatanggap Mo',
    govVotingTitle: 'Karapatang Bumoto sa Governance',
    govVotingDesc: 'Lumahok sa mga DAO proposal at hubog ang direksyon ng protocol.',
    protocolAccessTitle: 'Protocol Access',
    protocolAccessDesc: 'Gamitin ang VFIDE tokens para bayaran ang mga commerce fee, vault fee, at ma-access ang premium features.',
    dutyPointsTitle: 'Governance Duty Points',
    dutyPointsDesc: 'Hindi maaaring ilipat na pagsubaybay ng pakikilahok na sumasalamin sa iyong kontribusyon — hindi kita.',
    whyNoRewardsTitle: 'Bakit walang rewards?',
    whyNoRewardsBody: 'Ang mga referral bonus, merchant incentive, at yield ay lumilikha ng inaasahang kita mula sa pagsisikap ng iba — ang ikatlo at ikaapat na pamantayan ng Howey Test. Tinatanggal ng VFIDE ang lahat ng naturang mekanismo.',
    govCta: 'Pumunta sa Governance',
    docsCta: 'Basahin ang Docs',
  },
  'hi-IN': {
    heading: 'कोई टोकन रिवॉर्ड नहीं',
    subheading: 'डिज़ाइन द्वारा — आपकी सुरक्षा के लिए',
    body: 'VFIDE एक गवर्नेंस यूटिलिटी टोकन है। कोई रेफरल बोनस, मर्चेंट इंसेंटिव, लॉक बोनस या कोई अन्य लाभ-वितरण तंत्र नहीं है — डिज़ाइन द्वारा, यह सुनिश्चित करने के लिए कि VFIDE को सुरक्षा के रूप में वर्गीकृत न किया जाए।',
    whatYouGet: 'आपको क्या मिलता है',
    govVotingTitle: 'गवर्नेंस मतदान अधिकार',
    govVotingDesc: 'DAO प्रस्तावों में भाग लें और प्रोटोकॉल की दिशा को आकार दें।',
    protocolAccessTitle: 'प्रोटोकॉल एक्सेस',
    protocolAccessDesc: 'वाणिज्य शुल्क, वॉल्ट शुल्क का भुगतान करने और प्रीमियम सुविधाओं तक पहुँचने के लिए VFIDE टोकन का उपयोग करें।',
    dutyPointsTitle: 'गवर्नेंस ड्यूटी पॉइंट्स',
    dutyPointsDesc: 'गैर-हस्तांतरणीय भागीदारी ट्रैकिंग जो आपके प्रोटोकॉल योगदान को दर्शाती है — लाभ नहीं।',
    whyNoRewardsTitle: 'रिवॉर्ड क्यों नहीं?',
    whyNoRewardsBody: 'रेफरल बोनस, मर्चेंट इंसेंटिव और यील्ड दूसरों के प्रयासों से लाभ की अपेक्षा बनाते हैं — हावी टेस्ट का तीसरा और चौथा मानदंड। VFIDE जानबूझकर ऐसे सभी तंत्रों को छोड़ता है।',
    govCta: 'गवर्नेंस पर जाएं',
    docsCta: 'दस्तावेज़ पढ़ें',
  },
  'id-ID': {
    heading: 'Tidak Ada Hadiah Token',
    subheading: 'Sengaja dirancang — untuk perlindungan Anda',
    body: 'VFIDE adalah token utilitas tata kelola. Tidak ada bonus referral, insentif merchant, bonus kunci, atau mekanisme distribusi keuntungan lainnya — sengaja, untuk memastikan VFIDE tidak diklasifikasikan sebagai sekuritas.',
    whatYouGet: 'Yang Anda Dapatkan',
    govVotingTitle: 'Hak Suara Tata Kelola',
    govVotingDesc: 'Berpartisipasi dalam proposal DAO dan membentuk arah protokol.',
    protocolAccessTitle: 'Akses Protokol',
    protocolAccessDesc: 'Gunakan token VFIDE untuk membayar biaya perdagangan, biaya vault, dan mengakses fitur premium.',
    dutyPointsTitle: 'Poin Kewajiban Tata Kelola',
    dutyPointsDesc: 'Pelacakan partisipasi tidak dapat dipindahtangankan yang mencerminkan kontribusi Anda pada protokol — bukan keuntungan.',
    whyNoRewardsTitle: 'Mengapa tidak ada hadiah?',
    whyNoRewardsBody: 'Bonus referral, insentif merchant, dan hasil menciptakan ekspektasi keuntungan dari upaya orang lain — kriteria ketiga dan keempat Howey Test. VFIDE sengaja menghilangkan semua mekanisme tersebut.',
    govCta: 'Ke Tata Kelola',
    docsCta: 'Baca Dokumentasi',
  },
  'th-TH': {
    heading: 'ไม่มีรางวัลโทเค็น',
    subheading: 'ออกแบบมาเพื่อ — ปกป้องคุณ',
    body: 'VFIDE เป็นโทเค็นอรรถประโยชน์การกำกับดูแล ไม่มีโบนัสการแนะนำ สิ่งจูงใจสำหรับผู้ค้า โบนัสการล็อค หรือกลไกการกระจายผลกำไรอื่นใด — โดยออกแบบ เพื่อให้แน่ใจว่า VFIDE ไม่ถูกจำแนกเป็นหลักทรัพย์',
    whatYouGet: 'สิ่งที่คุณได้รับ',
    govVotingTitle: 'สิทธิ์การลงคะแนนเสียงกำกับดูแล',
    govVotingDesc: 'มีส่วนร่วมในข้อเสนอ DAO และกำหนดทิศทางของโปรโตคอล',
    protocolAccessTitle: 'การเข้าถึงโปรโตคอล',
    protocolAccessDesc: 'ใช้โทเค็น VFIDE เพื่อชำระค่าธรรมเนียมการค้า ค่าธรรมเนียม vault และเข้าถึงฟีเจอร์พรีเมียม',
    dutyPointsTitle: 'คะแนนหน้าที่กำกับดูแล',
    dutyPointsDesc: 'การติดตามการมีส่วนร่วมที่ไม่สามารถโอนได้ ซึ่งสะท้อนถึงการมีส่วนร่วมของคุณในโปรโตคอล — ไม่ใช่กำไร',
    whyNoRewardsTitle: 'ทำไมถึงไม่มีรางวัล?',
    whyNoRewardsBody: 'โบนัสการแนะนำ สิ่งจูงใจสำหรับผู้ค้า และผลตอบแทนสร้างความคาดหวังกำไรจากความพยายามของผู้อื่น — เกณฑ์ที่สามและสี่ของ Howey Test VFIDE ตั้งใจละเว้นกลไกทั้งหมดดังกล่าว',
    govCta: 'ไปที่การกำกับดูแล',
    docsCta: 'อ่านเอกสาร',
  },
  'ja-JP': {
    heading: 'トークン報酬なし',
    subheading: '設計上 — あなたの保護のため',
    body: 'VFIDEはガバナンスユーティリティトークンです。紹介ボーナス、加盟店インセンティブ、ロックボーナス、その他の利益分配メカニズムは存在しません — 設計上、VFIDEがハウイテストの下で有価証券に分類されないよう保証するためです。',
    whatYouGet: '得られるもの',
    govVotingTitle: 'ガバナンス投票権',
    govVotingDesc: 'DAOの提案に参加し、プロトコルの方向性を形作ります。',
    protocolAccessTitle: 'プロトコルアクセス',
    protocolAccessDesc: 'VFIDEトークンを使用して商取引手数料、Vault手数料を支払い、プレミアム機能にアクセスします。',
    dutyPointsTitle: 'ガバナンス義務ポイント',
    dutyPointsDesc: 'プロトコルへの貢献を反映する譲渡不可の参加追跡 — 利益ではなく。',
    whyNoRewardsTitle: 'なぜ報酬がないのか？',
    whyNoRewardsBody: '紹介ボーナス、加盟店インセンティブ、利回りは他者の努力からの利益期待を生み出します — ハウイテストの第3・第4要件。VFIDEはトークンの保有や使用が投資契約とみなされないよう、これらのメカニズムをすべて意図的に省いています。',
    govCta: 'ガバナンスへ',
    docsCta: 'ドキュメントを読む',
  },
  'zh-CN': {
    heading: '无代币奖励',
    subheading: '设计使然 — 为了您的保护',
    body: 'VFIDE 是一种治理实用代币。没有推荐奖励、商家激励、锁仓奖励或任何其他利润分配机制 — 这是有意设计的，以确保 VFIDE 不被归类为 Howey 测试下的证券。',
    whatYouGet: '您将获得的',
    govVotingTitle: '治理投票权',
    govVotingDesc: '参与 DAO 提案，塑造协议的发展方向。',
    protocolAccessTitle: '协议访问',
    protocolAccessDesc: '使用 VFIDE 代币支付商业费用、金库费用，并访问高级功能。',
    dutyPointsTitle: '治理职责积分',
    dutyPointsDesc: '不可转让的参与追踪，反映您对协议的贡献 — 而非利润。',
    whyNoRewardsTitle: '为什么没有奖励？',
    whyNoRewardsBody: '推荐奖励、商家激励和收益会产生依赖他人努力获利的预期 — 这是 Howey 测试的第三和第四条准则。VFIDE 有意省去所有此类机制，以避免代币持有或使用被认定为投资合同。',
    govCta: '前往治理',
    docsCta: '阅读文档',
  },
};
