...
jest.mock('wagmi', () => ({ /* CANONICAL_WAGMI_MOCK_V2 */
  ...
  useReadContract: jest.fn((args: any) => {
    if (args?.functionName === 'owner') return { data: mockOwnerAddress, isError: false, isLoading: false, isSuccess: true, error: null, refetch: jest.fn() }
